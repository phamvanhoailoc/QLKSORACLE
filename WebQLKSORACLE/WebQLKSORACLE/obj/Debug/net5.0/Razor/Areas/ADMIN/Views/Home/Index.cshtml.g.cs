#pragma checksum "E:\Hoc Tap\oracle\QLKS\WebQLKSORACLE\WebQLKSORACLE\Areas\ADMIN\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "3b99e96c9cc24e69e8705af3577412633fc26f93"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"3b99e96c9cc24e69e8705af3577412633fc26f93", @"/Areas/ADMIN/Views/Home/Index.cshtml")]
...
<div class=""row small-spacing"">
        ...
        <div class=""box-content"">
            ...
            <div class=""dropdown js__drop_down"">
                ...
                <ul class=""sub-menu"">
                    <li><a href=""#"">Action</a></li>
                    <li><a href=""#"">Another action</a></li>
                    <li><a href=""#"">Something else there");
            WriteLiteral(@"</a></li>
                    <li class=""split""></li>
                    <li><a href=""#"">Separated link</a></li>
                </ul>
    ...
    <div class=""col-sm-6 col-lg-3 col-xs-12"">
        <div class=""box-content"">
            <h4 clas");
            WriteLiteral(@"s=""box-title text-success"">Site Traffic</h4>
            <!-- /.box-title -->
            <div class=""dropdown js__drop_down"">
                <a href=""#"" class=""dropdown-icon glyphicon glyphicon-option-vertical js__drop_down_button""></a>
                <ul class=""sub-menu"">
    ...
    <div class=""col-lg-3 col-md-6 col-xs-12"">
        <div class=""box-content bg-danger text-white"">
            <div class=""statistics-box with-icon"">
                ...
                <p class=""text text-");
            WriteLiteral(@"white"">FIXED BUG</p>
...
<div class=""row small-spacing"">
                ...
                <div class=""review-item"">
                    <div class=""top"">
                        ...
                        <div class=""star-rating text-warning"">
                            ...
                            <i class=""fa fa-star""></i>
                            <i class=");
            WriteLiteral(@"""fa fa-star-half-o""></i>
    ...
    ");
            ...
            WriteLiteral(@"v>
                ...
                <div class=""activity-item"">
                    ...
                    <div class=""content"">
                        <");
            WriteLiteral(@"div class=""date"">6 days ago</div>
                        <!-- /.date -->
    ...
    <div class=""col-lg-4 col-xs-12"">
        <div class=""box-content js__todo_widget"">
            ...
            ");
            WriteLiteral(@"<!-- /.dropdown js__dropdown -->
            <div class=""todo-list js__todo_list"">
                ...
                <!-- /.todo-item -->
                <div class=""todo-item"">
                    <div class=""checkbox success""><input type=""checkbo");
            WriteLiteral(@"x"" id=""todo-4""><label for=""todo-4"">Task To Do 4</label></div>
                    <!-- /.checkbox -->
                </div>
                <!-- /.todo-item -->
                <div class=""todo-item"">
...
<div class=""row small-spacing"">
        ...
        <div class=""box-content"">
            ...
            <div class=""dropdown js__drop_down"">
                ...
                <ul class=""sub-menu"">
                    ...
                    <li><a href=""#"">Another action</a></li>
                    <li><a href=""#"">Something else th");
            WriteLiteral(@"ere</a></li>
                    <li class=""split""></li>
                    <li><a href=""#"">Separated link</a></li>
                </ul>
                <!-- /.sub-menu -->
 ...
 ");
            WriteLiteral(@"                   <tr>
                    ...
                    <tr>
          ");
            WriteLiteral(@"              <td>Galaxy Note 5</td>
                        <td>$200</td>
                        <td>Oct 28,2016</td>
                        <td class=""text-success"">Completed</td>
                        <td><a href=""#""><i class=""fa fa-plus-circle""></i></a></td>
